    ...
    <body>
        ...
        <div id="map"></div>
            <section class="text-white" style="background-color: #1C2331; font-family:Roboto, sans-serif" id="about">
            <div class="container">
              <div class="row">
                        ...
                        <div class="container">
                          ...
                          <div class="row">
                               <div class="col-lg-12 text-center" style="margin-top:3rem">
                                    <button type="submit" name="submit" class="btn btn-primary btn-xl sr-button" >SUBMIT</button>
                               </div>     
                          </div>
